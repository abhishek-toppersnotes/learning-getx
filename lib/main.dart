...
class MyApp extends StatelessWidget {
  ...
  static const String title =
      "Reactive state mgmt using GetX() Builder function";
            ...
            children: [
              GetX<IncrementController>(
                ...
                builder: (controller) {
                  ...
                  // return Text(
                  //     "Current Value: ${controller.counterValue.value}");

                  // If we are having an instance defined somewhere else, [currentValue] received
                  // is not even required
                  return Text(
                      "Current Value: ${incrementController.counterValue.value}");
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  // If we have access to the [IncrementController] direcly
